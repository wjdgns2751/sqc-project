...
function FormComponent() {
  ...
  return (
    <div id="upload-container">
      <Form name="상품 추천받기" onFinish={onSubmit}>
        <Divider />
        <Form.Item
        ...
        >
          <Input
            ...
            size="large"
            placeholder="남성, 여성 중 선택해주세요."
          />
        </Form.Item>
        <Divider />
        <Form.Item
          name="name"
          label={<div className="upload-label">사이즈</div>}
          rules={[
            {
              required: true,
              message: "찾으시고자 하는 사이즈를 입력해주세요.",
            },
          ]}
        >
          <Input
